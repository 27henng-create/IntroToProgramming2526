...
// When text says "upstream is gone" the computer believes that there was something there before but doen't know what exactly.
...
// "const" will not allow you to change that variable since it is constant and it wont allow that varibale to EVER be changed
// like if you set "const second = 2;" and then try and override that code with "second = 4;" that const will keep the number the same
